    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            preferenceManager.sharedPreferences.registerOnSharedPreferenceChangeListener { _, key ->
                findPreference<Preference>(key)?.apply { updateSummary(this) }
            }
        }
            ...
            when (preference.key) {
                "CAPTURE_MODE_PREFERENCE" -> {
                    preference.apply {
                        ...
                        this.summary = String.format(
                            getString(R.string.capture_mode_summary),
                            if (value != "Not set") {
                                resources.getStringArray(R.array.capture_mode_items)[Integer.parseInt(
                                    value
                                )]
                            } else
                                value
                ...
                "EXPOSURE_COMPENSATION_VALUE" -> {
                    preference.apply {
                        ...
                        this.summary = String.format(
                            getString(R.string.exposure_compensation_summary),
                ...
                "SENSOR_EXPOSURE_TIME" -> {
                    preference.apply {
                        ...
                        this.summary = String.format(
                            getString(R.string.sensor_exposure_time_summary),
                ...
                "SENSOR_SENSITIVITY" -> {
                    preference.apply {
                        ...
                        this.summary = String.format(
                            getString(R.string.sensor_sensitivity_summary),
